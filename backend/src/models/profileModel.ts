...
import {
  getValidCountryValues,
  getValidLanguageValues,
...
export const updateUser = async (
  ...
  if (
    typeof draftFullname !== "string" ||
    typeof draftCountry !== "string" ||
    typeof draftLanguage !== "string" ||
    typeof draftTimezone !== "string"
  ) {
    throw { message: "Invalid fields value format", statusCode: 400 };
  }
