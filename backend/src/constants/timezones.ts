...
// Helper function to get valid timezone values for validation
export const getValidTimezoneValues = (): string[] => {
    return timezoneOptions.map(timezone => timezone.value);
}; 